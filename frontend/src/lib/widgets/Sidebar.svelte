...
>
	...
	>
		{#if darkModeOn}
			<Sun
				size={35}
				class="text-color-primary-light dark:text-color-primary-dark group-hover:text-color-hover-light dark:group-hover:text-color-hover-dark z-30"
			/>
		{:else}
			<Moon
				size={35}
