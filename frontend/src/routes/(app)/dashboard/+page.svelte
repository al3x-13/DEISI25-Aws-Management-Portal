...
<div class="w-full max-w-5xl flex flex-col items-center jusify-center pt-20">
	<PageTitle title="EC2 Instances" />

	<Table.Root class="mt-20 mb-10 text-base text-text-light dark:text-text-dark">
		<Table.Header>
		...
		<Table.Header>
			<Table.Row class="border-border-light dark:border-border-dark">
				...
				<Table.Head class="text-color-primary-light dark:text-color-primary-dark"
					>Pair Type</Table.Head
				>
				<Table.Head class="text-color-primary-light dark:text-color-primary-dark"
					>Private File Format</Table.Head
				>
				<Table.Head class="text-color-primary-light dark:text-color-primary-dark"
					>Access Type</Table.Head
				>
			</Table.Row>
		</Table.Header>
		<Table.Body>
			{#each keys as key}
				<Table.Row class="text-lg">
					...
					<Table.Cell class="text-text-light dark:text-text-dark"
						>{key.PrivateKeyFileFormat}</Table.Cell
					>
